...
FIX = '5d8324bde8b4ab86e7aedd16f12b58ac4f1f2ceb'
...
CODE_FILES = set(['tools/pnnx/src/ir.cpp', 'tools/pnnx/tests/CMakeLists.txt', 'tools/pnnx/tests/ncnn/test_attribute.py', 'tools/pnnx/tests/pnnx_test_utils.py', 'tools/pnnx/tests/test_exported_program_parameter_roundtrip.cpp', 'tools/pnnx/tests/test_pnnx_test_utils.py', 'tools/pnnx/tests/test_python_codegen_paths.py'])
...
def metadata():
    ...
    if len(versions) != len(VERSIONS) or set(versions) != set(VERSIONS):
