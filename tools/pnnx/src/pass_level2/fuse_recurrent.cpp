...
static bool fuse_recurrent(Operator* op)
{
    ...
    const size_t expected_weight_count = (size_t)num_layers * direction_count * weights_per_direction;
    ...
    {
        const int layer_input_size = layer == 0 ? input_size : recurrent_size * direction_count;
