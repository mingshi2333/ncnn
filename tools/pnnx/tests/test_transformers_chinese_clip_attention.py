...
def test():
    ...
    for a0, b0 in zip(a, b):
        if not torch.allclose(a0, b0, 1e-4, 1e-4):
            return check_numerical_result("test_transformers_chinese_clip_attention", False)
    return check_numerical_result("test_transformers_chinese_clip_attention", True)
